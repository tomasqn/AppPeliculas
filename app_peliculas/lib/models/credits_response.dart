...
//
//     final creditsClass = creditsClassFromMap(jsonString);
...
class CreditsClass {
    ...
    factory CreditsClass.fromJson(String str) => CreditsClass.fromMap(json.decode(str));

    factory CreditsClass.fromMap(Map<String, dynamic> json) => CreditsClass(
        id: json["id"],
